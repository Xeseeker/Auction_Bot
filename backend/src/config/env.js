...
export const config = {
  ...
  MONGO_URI:
    process.env.MONGO_URI || "mongodb://127.0.0.1:27017/telegram_auction",
...
if (!config.CHANNEL_ID) {
  console.error(
    "CHANNEL_ID is missing in the environment variables. The bot needs a channel to post auctions.",
  );
}
