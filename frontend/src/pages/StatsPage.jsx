    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-sand-100/60">{t('stats_subtitle')}</p>
        </div>
        ...
        <Panel title={t('highest_value_auctions')}>
          <DataTable
            ...
            columns={[
              ...
              {
                key: 'winner',
                label: t('winner_label'),
                render: (row) => person(row.highestBidder, t('not_available')),
              },
